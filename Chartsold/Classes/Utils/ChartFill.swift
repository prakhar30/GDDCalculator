...
open class ChartFill: NSObject
{
    ...
    open class func fillWithCGColor(_ CGColor: CGColor) -> ChartFill
    {
    ...
    open class func fillWithCGImage(_ CGImage: CGImage, tiled: Bool) -> ChartFill
    {
    ...
    open class func fillWithCGImage(_ CGImage: CGImage) -> ChartFill
    {
    ...
    open class func fillWithCGLayer(_ CGLayer: CGLayer) -> ChartFill
    {
